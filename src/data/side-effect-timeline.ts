...
export const medicationTimelines: MedicationTimeline[] = [
  ...
  },
  {
    ...
    symptoms: [
      {
        symptom: "Nausea",
        medianDurationDays: 7,
        peakWeek: 12,
        typicalOnset: "Within first week of each dose increase",
        typicalResolution: "Usually resolves within 3–7 days at each dose level",
        prevalencePercent: 52,
        placeboPercent: 14,
        notes: "Most common side effect. Dose-dependent: higher at 8 mg and 12 mg. Managed with smaller meals and avoiding high-fat foods.",
      },
      {
        symptom: "Diarrhea",
        medianDurationDays: 4,
        peakWeek: 12,
        typicalOnset: "Within days of dose increase",
        typicalResolution: "Typically resolves within 2–5 days",
        prevalencePercent: 31,
        placeboPercent: 9,
        notes: "Second most common GI effect. Ensure hydration. Dose-dependent pattern similar to nausea.",
      },
      {
        symptom: "Vomiting",
        medianDurationDays: 2,
        peakWeek: 12,
        typicalOnset: "Typically accompanies nausea during dose escalation",
        typicalResolution: "Resolves within 1–3 days at each dose step",
        prevalencePercent: 26,
        placeboPercent: 4,
        notes: "Less common than nausea but more frequent than with tirzepatide. Contact provider if persistent.",
      },
      {
        symptom: "Constipation",
        medianDurationDays: 21,
        peakWeek: 8,
        typicalOnset: "Can begin early; may persist between dose steps",
        typicalResolution: "Manageable with fiber and hydration; often improves at stable dose",
        prevalencePercent: 18,
        placeboPercent: 6,
        notes: "Lower prevalence than with semaglutide. Fiber supplementation and adequate fluid intake are recommended.",
      },
      {
        symptom: "Decreased appetite",
        medianDurationDays: null,
        peakWeek: null,
        typicalOnset: "Within first 2–4 weeks",
        typicalResolution: "Persists — this is the intended therapeutic effect",
        prevalencePercent: 45,
        placeboPercent: 8,
        notes: "Profound appetite suppression is a hallmark effect. Ensure adequate protein intake (1.2–1.6 g/kg/day) despite reduced hunger.",
      },
      {
        symptom: "Fatigue",
        medianDurationDays: null,
        ...
        prevalencePercent: 12,
        placeboPercent: 5,
        notes: "May be related to rapid weight loss and reduced caloric intake rather than direct drug effect.",
      },
      {
        symptom: "Headache",
        medianDurationDays: null,
        ...
        placeboPercent: 6,
        notes: "Mild and transient. Hydration and adequate caloric intake help.",
      },
      {
        symptom: "Skin sensitivity / allodynia",
        medianDurationDays: null,
        peakWeek: null,
        typicalOnset: "Variable; often after dose increases",
        typicalResolution: "May persist; management strategies unclear",
        prevalencePercent: 5,
        placeboPercent: 1,
        notes: "Anecdotal reports from trial participants describe dull, persistent skin sensitivity on arms and legs. Not well-characterized in published trial data.",
      },
    ],
    generalNotes: "Side effects are dose-dependent and most prominent during the 12–16 week escalation period. The 1 mg starting dose produces minimal symptoms; the 8 mg and 12 mg steps are where most GI effects emerge. Gradual titration is essential for tolerability. Discontinuation rates due to adverse events in Phase 2 were low (~5–8%). Long-term safety data from Phase 3 is pending.",
    source: "Jastreboff et al. (2023) — Triple-Hormone-Receptor Agonist Retatrutide for Obesity. N Engl J Med. + Phase 2 diabetes trial (Lancet 2023) + participant-reported data.",
