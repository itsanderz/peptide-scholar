...
export const sideEffectProfiles: SideEffectProfile[] = [
  {
    ...
    sideEffects: [
      { name: "Nausea", drugPercent: 25, placeboPercent: 5 },
      { name: "Diarrhea", drugPercent: 23, placeboPercent: 9 },
      { name: "Constipation", drugPercent: 17, placeboPercent: 9 },
      { name: "Abdominal pain", drugPercent: 13, placeboPercent: 7 },
      { name: "Vomiting", drugPercent: 9, placeboPercent: 3 },
      { name: "Dyspepsia", drugPercent: 8, placeboPercent: 4 },
      { name: "Dysesthesia", drugPercent: 8, placeboPercent: 3 },
      { name: "Headache", drugPercent: 6, placeboPercent: 5 },
      { name: "Fatigue", drugPercent: 5, placeboPercent: 4 },
      { name: "Dizziness", drugPercent: 5, placeboPercent: 3 },
      { name: "Abdominal distention", drugPercent: 4, placeboPercent: 2 },
      { name: "Eructation", drugPercent: 3, placeboPercent: 2 },
    ],
    discontinuationRate: { drug: 6.8, placebo: 3.2 },
    source: "Wegovy FDA Label — Pooled STEP 1, 3, 4 data",
    sourceUrl: "https://www.novomedlink.com/obesity/products/treatments/wegovy/efficacy-safety/safety-profile.html",
  },
  {
    ...
    dose: "5mg weekly",
    trialName: "SURPASS (pooled)",
    sideEffects: [
      { name: "Nausea", drugPercent: 12, placeboPercent: 4 },
      { name: "Diarrhea", drugPercent: 12, placeboPercent: 9 },
      { name: "Dyspepsia", drugPercent: 8, placeboPercent: 3 },
      { name: "Constipation", drugPercent: 6, placeboPercent: 1 },
      { name: "Abdominal pain", drugPercent: 6, placeboPercent: 4 },
      { name: "Decreased appetite", drugPercent: 5, placeboPercent: 1 },
      { name: "Vomiting", drugPercent: 5, placeboPercent: 2 },
    ],
    discontinuationRate: { drug: 4.3, placebo: 2.6 },
    source: "Mounjaro FDA Label — SURPASS trial data",
    sourceUrl: "https://medical.lilly.com/us/products/answers/what-are-the-common-adverse-events-with-mounjaro-tirzepatide-in-adults-310838",
  },
  {
    ...
    trialName: "SURPASS (pooled)",
    sideEffects: [
      { name: "Nausea", drugPercent: 15, placeboPercent: 4 },
      { name: "Diarrhea", drugPercent: 13, placeboPercent: 9 },
      { name: "Dyspepsia", drugPercent: 8, placeboPercent: 3 },
      { name: "Constipation", drugPercent: 6, placeboPercent: 1 },
      { name: "Decreased appetite", drugPercent: 10, placeboPercent: 1 },
  ...
  },
  {
    ...
    trialName: "SURPASS (pooled)",
    sideEffects: [
      { name: "Nausea", drugPercent: 18, placeboPercent: 4 },
      { name: "Diarrhea", drugPercent: 17, placeboPercent: 9 },
      { name: "Decreased appetite", drugPercent: 11, placeboPercent: 1 },
      { name: "Vomiting", drugPercent: 9, placeboPercent: 2 },
      { name: "Constipation", drugPercent: 7, placeboPercent: 1 },
      { name: "Dyspepsia", drugPercent: 5, placeboPercent: 3 },
      { name: "Abdominal pain", drugPercent: 5, placeboPercent: 4 },
    ],
